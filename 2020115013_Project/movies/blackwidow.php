<?php
session_start();
$_SESSION["movie"] ="Black Widow";
$_SESSION["moviecode"] = "black";
...
<body>
    ...
    <main class="movie-desc">
        <div class="movie-title-flex">
            <h2 class="movie-name-title">Black Widow</h2>
            <div class="book"><a href="../book/book.php" class="booklink">Book Tickets</a></div>
        </div>
        <div class="movie-flex">
            <img src="../img/movies/black.jpg" alt="image" class="movie-image" height="250" width="150">
            <div class="movie-title-desc">
                ...
                <div class="runtime-dir">Duration : 2 hr 13 min<br><br>Directed by : Cate Shortland</div>
            </div>
        </div>
        <div class="cast-crew">
            ...
            <div class="cast-flex">
                <div class="cast">
                    <img src="../img/movies/scarlet.jpg" alt="image" class="cast-photo" height="150" width="140">
                    <div class="cast-name">Scarlet</div>
                </div>
                <div class="cast">
                    <img src="../img/movies/rachel.jpg" alt="image" class="cast-photo" height="150" width="140">
                    <div class="cast-name">Rachel</div>
                </div>
        ...
        <div class="trailers">
            ...
            <iframe width="560" height="315" src="https://www.youtube.com/embed/Fp9pNPdNwjI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen class="youtubevideo"></iframe>
        </div>
