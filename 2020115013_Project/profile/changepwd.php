...
<body>
    ...
    <main class="profile-page">
        ...
        <form method='POST' name='changeform' class='details-form'><fieldset class='field'><legend class='title-pwd'>Change Password</legend><br><input type='password' placeholder='Enter your New Password' name='password' class='inputform'><br><input type='password' placeholder='Confirm your Password' name='confirmpassword' class='inputform'><br><input type='submit' onclick='validateform()'value='Change Password' class='changepwd full' name='changed'></fieldset></form>
        <?php
        if(isset($_POST["password"]) && isset($_POST["confirmpassword"]))
        {
            ...
            $update = "update login set Password='$pwd' where Name='$name'";
